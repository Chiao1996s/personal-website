...
export default function Nav() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur border-b border-gray-200 dark:border-gray-800">
      <div className="max-w-4xl mx-auto px-6 h-14 flex items-center justify-between">
        <Link href="/" className="font-semibold text-gray-900 dark:text-gray-100 hover:text-blue-600 transition-colors">
          Chiao Lin
        </Link>
